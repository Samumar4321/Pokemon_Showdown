 ...
 * @author Startex
 */
public class StatisticaPokemonGui extends javax.swing.JFrame {

    /**
     * Creates new form StatisticaPokemonGui
     */
    public StatisticaPokemonGui() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOME POK");

        jLabel2.setText("HP");

        jLabel3.setText("ATTACCO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatisticaPokemonGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatisticaPokemonGui().setVisible(true);
            }
        });
    }
